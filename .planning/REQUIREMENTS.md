...
- [x] **AUTH-01**: Trainer can create an account with email and password.
- [x] **AUTH-02**: Client can create an account with email and password.
- [x] **AUTH-03**: User can sign in and stay signed in across browser refresh.
- [x] **AUTH-04**: User can sign out from any authenticated page.
...
- [x] **RELA-03**: Trainer can view their active client list.

### Video Submissions

- [x] **SUBM-01**: Client can upload a training video file from mobile or desktop browser.
...
- [x] **SUBM-05**: Client can view their own submission history list.
...
| CLFB-01 | Phase 4 | Pending |
| CLFB-02 | Phase 4 | Pending |
| CLFB-03 | Phase 4 | Pending |
| CLFB-04 | Phase 4 | Pending |
